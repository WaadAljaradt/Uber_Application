...
exports.getDriverProfile = function(msg, callback){
	...
	mysql.getConnection(function(err, conn){
		...
		var sqlQuery = "select firstname,lastname,address,city,state,zipcode,phone,carnumber,carmodel,ssnnumber from drivers where email = '"+msg.email+"';";
...
exports.driverUpdateProfile = function(msg, callback){
	...
	mysql.getConnection(function(err, conn){
		...
		var sqlQuery = "update drivers set firstname='"+msg.firstname+"',lastname='"+msg.lastname+"',address='"+msg.address+"',city='"+msg.city+"',state='"+msg.state+"',zipcode='"+msg.zipcode+"',phone='"+msg.phone+"',carnumber='"+msg.carNumber+"',carmodel='"+msg.carModel+"',ssnnumber='"+msg.ssnNumber+"' where email ='"+msg.email+"'";
